...
- #34: Kamogelo's baseline persistence/comparison API; code complete and pushed on `feature/p2-api-1-baselines`, awaiting review against `develop`, not yet merged.
